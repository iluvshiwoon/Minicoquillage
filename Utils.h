...
int						m_open(t_mini *mini, const char *pathname, int flags,
							mode_t mode);
...
char					*mini_ft_strjoin(t_mini *mini, char const *s1,
							char const *s2);
char					*mini_ft_strdup(t_mini *mini, const char *s);
char					**mini_ft_split(t_mini *mini, char const *s, char c);
char					*mini_ft_strtrim(t_mini *mini, char const *s1,
							char const *set);
char					*mini_ft_substr(t_mini *mini, char const *s,
