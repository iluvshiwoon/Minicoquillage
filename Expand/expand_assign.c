...
void __assign(t_to_expand * _expand, char * r_value, t_index * index, bool litteral)
{
    if (r_value)
    {
...
void __assign_copy(t_to_expand * _expand, t_index * index, bool litteral, char * to_expand)
{
    _expand->litteral[index->j] = litteral;
