...
/*   Updated: 2024/11/26 15:37:14 by kgriset          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../Minicoquillage.h"

void    _exec_pipe(t_mini * mini, t_parser_node ** p_node, t_ast_node ** first_node, t_exec * exec)
{
    t_ast_node * left;
...
void _exec_exec(t_mini * mini, t_parser_node ** p_node, t_ast_node ** first_node, t_exec * exec)
{
    char ** globbed;
